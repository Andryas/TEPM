...
colocar os pacotes necessários aqui....
...
```{r, echo = FALSE}
dist <- readRDS("data/codigos_exemplo_1.rds")
dist %>%
    kableExtra::kbl(
        align = 'c',
        booktabs = TRUE, 
...
```{r, echo = FALSE}
dist <- readRDS("data/codigos_exemplo_2.rds")
dist %>%
    kableExtra::kbl(
        align = 'c',
        booktabs = TRUE, 
...
write.csv2(distance_matrix, "data/distance_matrix.csv", row.names = FALSE)
...
write.csv2(duration_matrix, "data/duration_matrix.csv", row.names = FALSE)
...
write.csv2(cidade_id, "data/cidade_id.csv", row.names = FALSE)
```